...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/home/qiuzy/programs/verl_dev/data/gsm8k/train.parquet \
    data.val_files=/home/qiuzy/programs/verl_dev/data/gsm8k/test.parquet \
    ...
    trainer.nnodes=1 \
    +trainer.rollout_data_dir=/home/qiuzy/programs/verl_dev/dump \
    +trainer.rollout_length_dir=/home/qiuzy/programs/verl_dev/dump \
