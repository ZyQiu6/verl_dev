...
python3 -m verl.trainer.main_ppo_offpolicy \
    ...
    trainer.experiment_name='sequence-level offpolicy gen1 train4' \
    trainer.n_gpus_per_node=5 \
    trainer.nnodes=1 \
    +trainer.rollout_data_dir=/data/home/scyb166/zyqiu/verl_dev/dump/3b_off \
    +trainer.rollout_length_dir=/data/home/scyb166/zyqiu/verl_dev/dump/3b_off \
