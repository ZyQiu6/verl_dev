...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input", type=str, default="RUC-AIBOX/STILL-3-Preview-RL-Data"
    )
    parser.add_argument("--output", type=str, default="./data/sky-t1")
    ...
    for split in ["train"]:
        ...
        for data_entry in tqdm(cur_dataset):
            cur_data = {
                "data_source": "sky_t1_math_skill3",
                "prompt": [
    ...
    for split in ["validation"]:
        ...
        for data_entry in tqdm(math500_dataset["test"]):
            cur_data = {
                "data_source": "sky_t1_math_math500",
                "prompt": [
                    {"role": "system", "content": short_system_prompt},
                    {
                        "role": "user",
        ...
        for data_entry in tqdm(olympiads_dataset["train"]):
            cur_data = {
                "data_source": "sky_t1_math_OlympiadBench",
                "prompt": [
                    {"role": "system", "content": short_system_prompt},
                    {
                        "role": "user",
