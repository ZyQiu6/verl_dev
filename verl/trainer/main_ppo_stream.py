...
from verl.trainer.ppo.ray_trainer_stream import RayPPOTrainer
...
class TaskRunner:
    def run(self, config):
        ...
        from verl.trainer.ppo.ray_trainer_stream import ResourcePoolManager, Role
        ...
        resource_pool_spec = {
            ...
            critic_pool_id: [1] * config.trainer.nnodes,
        }
        mapping = {
